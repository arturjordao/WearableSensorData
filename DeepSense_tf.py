...
"""
criar leitor para os arquivos .csv 
decodifica dados dos arquivos .csv
...
"""
Cria fila com nome dos arquivos 
exemple, label - sao os dados para treinamento
depois usa metodo do tf para dividir as amostras em partes
"""
...
csvFileList = []
csvDataFolder1 = os.path.join('C:/Users/sena/Downloads/sepHARData_a/sepHARData_' + select, "train")
...
csvEvalFileList = []
csvDataFolder2 = os.path.join('C:/Users/sena/Downloads/sepHARData_a/sepHARData_' + select, "eval")
